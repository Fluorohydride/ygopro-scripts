...
function c55586621.spfilter(c,e,tp)
	return c:IsSetCard(0x31) and c:IsCanBeSUMMON_VALUE_FORTUNE_LADY,tp,false,false)
end
...
function c55586621.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) then
		Duel.SpecialSummon(tc,SUMMON_VALUE_FORTUNE_LADY,tp,tp,false,false,POS_FACEUP)
	end
end
