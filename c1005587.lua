...
function c1005587.filter(c,tp)
	return aux.NegateMonsterTargetFilter(c) and c:IsAttackAbove(2000) and c:IsSummonPlayer(tp) and not c:IsDisabled()
end
...
function c1005587.filter2(c,e,tp)
	return aux.NegateMonsterTargetFilter(c) and c:IsAttackAbove(2000)
