...
function c14920218.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(14920218,0))
	...
	e2:SetDescription(aux.Stringid(14920218,1))
	e2:SetCategory(CATEGORY_TOHAND)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_SUMMON_SUCCESS)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_DAMAGE_STEP+EFFECT_FLAG_DELAY)
	e2:SetCountLimit(1,14920219)
	e2:SetTarget(c14920218.thtg)
	e2:SetOperation(c14920218.thop)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
