...
function c71340250.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=aux.SelectMatchingCardCrossField(tp,c71340250.filter,tp,LOCATION_DECK,0,1,1,nil,e,tp)
...
function c71340250.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and Duel.SpecialSummon(tc,0,tp,tp,true,false,POS_FACEUP)~=0 then
		...
		tc:RegisterFlagEffect(71340250,RESET_EVENT+0x1fe0000,0,1,fid)
