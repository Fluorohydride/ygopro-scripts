...
function c34853266.initial_effect(c)
	...
	e2:SetOperation(c34853266.retreg)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
...
function c34853266.retreg(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetCondition(c34853266.retcon)
	e1:SetTarget(c34853266.rettg)
	e1:SetOperation(c34853266.retop)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	e2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	c:RegisterEffect(e2)
end
function c34853266.retcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
...
function c34853266.rettg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,e:GetHandler(),1,0,0)
end
function c34853266.retop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
