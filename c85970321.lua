...
function c85970321.initial_effect(c)
	...
	e3:SetCondition(c85970321.retcon)
	e3:SetTarget(c85970321.rettg)
	e3:SetOperation(c85970321.retop)
	c:RegisterEffect(e3)
	aux.RegisterSummonFlag(c,EVENT_SUMMON_SUCCESS,85970321)
end
...
function c85970321.retcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(85970321)~=0
end
