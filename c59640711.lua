...
function c59640711.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(59640711,0))
...
function c59640711.spfilter(c,e,tp)
	return c:IsSetCard(0x2016) and not c:IsCode(59640711) and c:IsType(TYPE_TUNER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c59640711.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c59640711.spfilter,tp,LOCATION_HAND+LOCATION_GRAVE,0,1,1,nil,e,tp)
