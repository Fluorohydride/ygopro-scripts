...
function c99330325.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if sg:GetCount()>0 and not Duel.IsPlayerAffectedByEffect(tp,59822133)
		...
		local g2=aux.SelectMatchingCardCrossField(tp,c99330325.filter2,tp,LOCATION_DECK,0,1,1,nil,e,tp,tc1:GetCode())
...
function c99330325.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=aux.SelectMatchingCardCrossField(tp,c99330325.thfilter,tp,LOCATION_DECK,0,1,1,nil)
