...
function c59123937.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(59123937,1))
	e3:SetCategory(CATEGORY_SPECIAL_SUMMON+CATEGORY_FUSION_SUMMON)
	e3:SetType(EFFECT_TYPE_IGNITION)
	e3:SetRange(LOCATION_GRAVE)
	e3:SetCountLimit(1,59123938)
	e3:SetCondition(c59123937.condition)
	e3:SetTarget(c59123937.target)
	e3:SetOperation(c59123937.operation)
	c:RegisterEffect(e3)
end
...
function c59123937.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	c:RegisterFlagEffect(59123937,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,EFFECT_FLAG_CLIENT_HINT,1,0,227)
end
