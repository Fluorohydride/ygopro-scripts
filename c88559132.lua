...
function c88559132.spcon(e,c)
	...
	return ft>-1 and Duel.CheckReleaseGroupEx(tp,c88559132.spfilter,1,REASON_SPSUMMON,false,nil,ft,tp)
end
function c88559132.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	local g=Duel.SelectReleaseGroupEx(tp,c88559132.spfilter,1,1,REASON_SPSUMMON,false,nil,ft,tp)
