...
function c65247798.initial_effect(c)
	...
	e3:SetCondition(c65247798.retcon)
	e3:SetTarget(c65247798.rettg)
	e3:SetOperation(c65247798.retop)
	c:RegisterEffect(e3)
	aux.RegisterSummonFlag(c,EVENT_SUMMON_SUCCESS,65247798)
end
...
function c65247798.retcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetFlagEffect(65247798)~=0
end
