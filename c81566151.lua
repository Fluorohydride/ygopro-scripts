...
function c81566151.matfilter(c,fc)
	return c:IsFusionCode(89943723,89621922) and c:IsAbleToDeckOrExtraAsCost() and c:IsCanBeFusionMaterial(fc,SUMMON_TYPE_SPECIAL)
end
...
function c81566151.spcon(e,c)
	...
	local g=Duel.GetMatchingGroup(c81566151.matfilter,tp,LOCATION_ONFIELD,0,nil,c)
