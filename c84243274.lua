...
function c84243274.matfilter(c,fc)
	return c:IsFusionCode(58859575,91998119) and c:IsAbleToRemoveAsCost() and c:IsCanBeFusionMaterial(fc,SUMMON_TYPE_SPECIAL)
end
...
function c84243274.spcon(e,c)
	...
	local g=Duel.GetMatchingGroup(c84243274.matfilter,tp,LOCATION_ONFIELD,0,nil,c)
