...
function c78033100.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if e:GetLabel()==0 then
		g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c78033100.spfilter1,e),tp,0x13,0,1,1,nil,e,tp)
	else
		g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c78033100.spfilter2,e),tp,0x13,0,1,1,nil,e,tp)
	end
	local tc=g:GetFirst()
