...
function c97688360.initial_effect(c)
	...
	e1:SetCondition(c97688360.atkcon)
...
function c97688360.atkcon(e,tp,eg,ep,ev,re,r,rp)
...
function c97688360.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=aux.SelectMatchingCardCrossField(tp,c97688360.thfilter,tp,LOCATION_DECK,0,1,1,nil)
