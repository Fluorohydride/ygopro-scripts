...
function c89544521.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(89544521,0))
	...
	e4:SetDescription(aux.Stringid(89544521,1))
...
function c89544521.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and Duel.Destroy(tc,REASON_EFFECT)~=0 then
		...
		local g=aux.SelectMatchingCardCrossField(tp,c89544521.spfilter,tp,LOCATION_DECK,0,1,1,nil,e,tp)
