...
function c11502550.matfilter(c)
	return c:IsFusionCode(89943723,54959865) and c:IsAbleToDeckOrExtraAsCost() and c:IsCanBeFusionMaterial(fc,SUMMON_TYPE_SPECIAL)
end
...
function c11502550.spcon(e,c)
	...
	local g=Duel.GetMatchingGroup(c11502550.matfilter,tp,LOCATION_ONFIELD,0,nil,c)
