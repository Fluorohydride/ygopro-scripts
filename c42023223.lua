...
function c42023223.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=aux.SelectMatchingCardCrossField(tp,c42023223.thfilter,tp,LOCATION_DECK,0,1,1,nil)
...
function c42023223.spop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0 then
		...
		local g=aux.SelectMatchingCardCrossField(tp,c42023223.spfilter,tp,LOCATION_DECK,0,1,1,nil,e,tp)
		if g:GetCount()>0 then
