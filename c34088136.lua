...
function c34088136.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--reg
	aux.RegisterSummonFlag(c,EVENT_SUMMON_SUCCESS,34088137)
	aux.RegisterSummonFlag(c,EVENT_SPSUMMON_SUCCESS,34088137)
	aux.RegisterSummonFlag(c,EVENT_FLIP,34088137)
end
