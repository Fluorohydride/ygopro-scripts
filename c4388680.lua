...
function c4388680.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local hg=aux.SelectMatchingCardCrossField(tp,c4388680.thfilter,tp,LOCATION_DECK,0,1,1,nil)
	if hg:GetCount()>0 and Duel.SendtoHand(hg,tp,REASON_EFFECT)>0
		and hg:GetFirst():IsLocation(LOCATION_HAND) then
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
		local g=aux.SelectMatchingCardCrossField(tp,c4388680.tgfilter,tp,LOCATION_DECK,0,1,1,nil)
