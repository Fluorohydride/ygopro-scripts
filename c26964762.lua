...
function c26964762.deckop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g1=aux.SelectMatchingCardCrossField(tp,c26964762.filter,tp,LOCATION_DECK,0,1,1,nil)
	Duel.Hint(HINT_SELECTMSG,1-tp,aux.Stringid(26964762,3))
	local g2=aux.SelectMatchingCardCrossField(1-tp,c26964762.filter,1-tp,LOCATION_DECK,0,1,1,nil)
