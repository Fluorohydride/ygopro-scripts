...
function c20403123.hspcon(e,c)
	...
	return ft>-1 and Duel.CheckReleaseGroup(REASON_SPSUMMON,tp,c20403123.hspfilter,1,nil,ft,tp)
end
function c20403123.hspop(e,tp,eg,ep,ev,re,r,rp,c)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	local g=Duel.SelectReleaseGroup(REASON_SPSUMMON,tp,c20403123.hspfilter,1,1,nil,ft,tp)
