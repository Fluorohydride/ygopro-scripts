...
function c23837054.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		return Duel.IsPlayerCanSpecialSummonMonster(tp,24837055,0,0x4011,0,0,2,RACE_REPTILE,ATTRIBUTE_DARK)
...
function c23837054.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local res1=Duel.IsPlayerCanSpecialSummonMonster(tp,24837055,0,0x4011,0,0,2,RACE_REPTILE,ATTRIBUTE_DARK)
	...
	elseif res1 then
		for i=1,2 do
			local token=Duel.CreateToken(tp,24837055)
