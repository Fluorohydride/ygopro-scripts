...
function c40607210.tgop(e,tp,eg,ep,ev,re,r,rp)
	...
	if e:GetLabel()==0 then g=aux.SelectMatchingCardCrossField(1-tp,c40607210.tgfilter,1-tp,LOCATION_DECK,0,1,1,nil,TYPE_MONSTER)
	elseif e:GetLabel()==1 then g=aux.SelectMatchingCardCrossField(1-tp,c40607210.tgfilter,1-tp,LOCATION_DECK,0,1,1,nil,TYPE_SPELL)
	else g=aux.SelectMatchingCardCrossField(1-tp,c40607210.tgfilter,1-tp,LOCATION_DECK,0,1,1,nil,TYPE_TRAP) end
