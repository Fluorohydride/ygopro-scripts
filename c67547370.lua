...
function c67547370.cfilter(c)
	return c:IsFaceup() and c:GetCounter(0x1039)==10
end
function c67547370.spcon(e,c)
	if c==nil then return true end
	return Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>-1
		and Duel.CheckReleaseGroup(c:GetControler(),c67547370.cfilter,1,nil)
end
function c67547370.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.SelectReleaseGroup(tp,c67547370.cfilter,1,1,nil)
