...
function c21558682.atktg1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if Duel.CheckEvent(EVENT_ATTACK_ANNOUNCE) then
		...
		if at and Duel.GetAttacker():IsControler(1-tp) and Duel.IsExistingTarget(c21558682.filter,tp,LOCATION_MZONE,0,1,at) and Duel.SelectYesNo(tp,aux.Stringid(21558682,1)) then
