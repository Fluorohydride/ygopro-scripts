...
function c86943389.regop(e,tp,eg,ep,ev,re,r,rp)
	e:GetHandler():RegisterFlagEffect(86943389,RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END,0,1)
end
function c86943389.thcon(e,tp,eg,ep,ev,re,r,rp)
	return bit.band(e:GetHandler():GetSummonType(),SUMMON_TYPE_SYNCHRO)==SUMMON_TYPE_SYNCHRO
		and e:GetHandler():GetFlagEffect(86943389)>0
end
...
function c86943389.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
