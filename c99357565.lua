...
function c99357565.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	local ct=math.min(2,Duel.GetMatchingGroupCount(c99357565.spfilter,tp,LOCATION_HAND+LOCATION_GRAVE+LOCATION_DECK,0,nil,e,tp))
...
function c99357565.spop(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if ft>=ct then
		...
		local g=Duel.SelectMatchingCard(tp,c99357565.spfilter,tp,LOCATION_HAND+LOCATION_GRAVE+LOCATION_DECK,0,ct,ct,nil,e,tp)
