...
function c57261568.hspcon(e,c)
	...
	return ft>-1 and Duel.CheckReleaseGroup(REASON_SPSUMMON,tp,c57261568.hspfilter,1,nil,ft,tp)
end
function c57261568.hspop(e,tp,eg,ep,ev,re,r,rp,c)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	local g=Duel.SelectReleaseGroup(REASON_SPSUMMON,tp,c57261568.hspfilter,1,1,nil,ft,tp)
