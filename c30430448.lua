...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then
		...
		return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(1-tp) and aux.NegateEffectMonsterFilter(chkc)
	end
	local b1=Duel.IsExistingTarget(aux.NegateEffectMonsterFilter,tp,0,LOCATION_MZONE,1,nil)
