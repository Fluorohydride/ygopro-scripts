...
function c39064822.sumtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsPlayerCanSummon(tp) and not Duel.CheckAdditionalSummon(tp) and (e:GetHandler():GetMutualLinkedGroupCount()>0 or Duel.GetFlagEffect(tp,39064822)==0) end
