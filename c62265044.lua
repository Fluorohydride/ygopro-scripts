...
function c62265044.operation1(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=aux.SelectMatchingCardCrossField(tp,c62265044.filter1,tp,LOCATION_DECK,0,1,1,nil)
...
function c62265044.operation2(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=aux.SelectMatchingCardCrossField(tp,c62265044.filter2,tp,LOCATION_DECK,0,1,1,nil)
	if g:GetCount()>0 then
