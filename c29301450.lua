...
function s.srmtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g=aux.SelectMultipleLocationTarget(HINTMSG_REMOVE,Card.IsAbleToRemove,tp,LOCATION_GRAVE+LOCATION_ONFIELD,LOCATION_GRAVE+LOCATION_ONFIELD,1,1,nil)
