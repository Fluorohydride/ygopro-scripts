...
function c28677304.matfilter(c,fc)
	return c:IsFusionCode(89943723,43237273) and c:IsAbleToDeckOrExtraAsCost() and c:IsCanBeFusionMaterial(fc,SUMMON_TYPE_SPECIAL)
end
...
function c28677304.spcon(e,c)
	...
	local g=Duel.GetMatchingGroup(c28677304.matfilter,tp,LOCATION_ONFIELD,0,nil,c)
