...
function c52714670.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(52714670,0))
...
function c52714670.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP)~=0 then
		tc:RegisterFlagEffect(52714670,RESET_EVENT+0x1fe0000,0,1)
...
function c52714670.rmcon(e,tp,eg,ep,ev,re,r,rp)
	return eg and eg:IsExists(c52714670.rmcfilter,1,e:GetHandler(),tp)
end
