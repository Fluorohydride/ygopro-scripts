...
function c43994202.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g1=Duel.SelectMatchingCard(tp,c43994202.filter,tp,LOCATION_DECK,1,1,nil,tp)
	if g1:GetCount()<=0 then return end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g2=Duel.SelectMatchingCard(tp,c43994202.filter2,tp,LOCATION_DECK,2,2,g1,g1:GetFirst():GetCode())
	g1:Merge(g2)
