...
function c44509529.excostfilter(c,ec,re,tp)
...
function c44509529.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	e:SetLabel(0)
	local g=Duel.GetMatchingGroup(c44509529.excostfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,nil,e:GetHandler(),re,tp)
