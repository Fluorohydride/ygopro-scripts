...
function c34830502.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--reg
	aux.RegisterSummonFlag(c,EVENT_SUMMON_SUCCESS,34830503)
	aux.RegisterSummonFlag(c,EVENT_SPSUMMON_SUCCESS,34830503)
	aux.RegisterSummonFlag(c,EVENT_FLIP,34830503)
end
