...
function c16802689.hspfilter(c)
	return c:IsSetCard(0xe6) and c:GetLevel()==12 and not c:IsCode(16802689)
end
function c16802689.hspcon(e,c)
	if c==nil then return true end
	return Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>-1
		and Duel.CheckReleaseGroup(c:GetControler(),c16802689.hspfilter,1,nil)
end
function c16802689.hspop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.SelectReleaseGroup(c:GetControler(),c16802689.hspfilter,1,1,nil)
