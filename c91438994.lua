...
function c91438994.initial_effect(c)
	...
	--add counter
	aux.RegisterEachTimeEvent(c,EVENT_TO_GRAVE,c91438994.filter1,LOCATION_MZONE,91438994)
	aux.RegisterEachTimeEvent(c,EVENT_REMOVE,c91438994.filter2,LOCATION_MZONE,91438995)
