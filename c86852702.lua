...
function c86852702.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local b1=(sel~=100 or Duel.IsExistingMatchingCard(Card.IsDiscardable,tp,LOCATION_HAND,0,1,c))
		and g1:GetClassCount(Card.GetCode)>1
	local b2=(sel~=100 or Duel.IsExistingMatchingCard(c86852702.costfilter,tp,LOCATION_HAND,0,1,c))
