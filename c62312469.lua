...
function c62312469.stop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsExistingMatchingCard(Card.IsAttribute,tp,LOCATION_DECK,0,1,nil,ATTRIBUTE_EARTH)
		...
		local g1=aux.SelectMatchingCardCrossField(tp,Card.IsAttribute,tp,LOCATION_DECK,0,1,1,nil,ATTRIBUTE_EARTH)
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TARGET)
		local g2=aux.SelectMatchingCardCrossField(tp,Card.IsAttribute,tp,LOCATION_DECK,0,1,1,nil,ATTRIBUTE_WATER)
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TARGET)
		local g3=aux.SelectMatchingCardCrossField(tp,Card.IsAttribute,tp,LOCATION_DECK,0,1,1,nil,ATTRIBUTE_FIRE)
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TARGET)
		local g4=aux.SelectMatchingCardCrossField(tp,Card.IsAttribute,tp,LOCATION_DECK,0,1,1,nil,ATTRIBUTE_WIND)
		g1:Merge(g2)
		g1:Merge(g3)
		g1:Merge(g4)
