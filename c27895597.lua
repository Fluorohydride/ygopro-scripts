...
function c27895597.tfilter(c,e,tp)
	return c:IsSetCard(0x31) and c:IsCanBeSpecialSummoned(e,SUMMON_VALUE_FORTUNE_LADY,tp,false,false)
...
function c27895597.spop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0 then
		...
		if g:GetCount()>0 then
			Duel.SpecialSummon(g,SUMMON_VALUE_FORTUNE_LADY,tp,tp,false,false,POS_FACEUP)
		end
	end
