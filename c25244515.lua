...
function c25244515.initial_effect(c)
	...
	e3:SetCondition(c25244515.retcon)
	e3:SetTarget(c25244515.rettg)
	e3:SetOperation(c25244515.retop)
	c:RegisterEffect(e3)
	aux.RegisterSummonFlag(c,EVENT_SUMMON_SUCCESS,25244515)
end
...
function c25244515.retcon(e,tp,eg,ep,ev,re,r,rp)
