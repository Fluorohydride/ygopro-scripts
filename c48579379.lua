...
function c48579379.spcon(e,c)
	...
	return ft>-1 and Duel.CheckReleaseGroupEx(tp,c48579379.rfilter,1,REASON_SPSUMMON,false,nil,ft,tp)
end
function c48579379.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	local g=Duel.SelectReleaseGroupEx(tp,c48579379.rfilter,1,1,REASON_SPSUMMON,false,nil,ft,tp)
