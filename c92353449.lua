...
function c92353449.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=aux.SelectMatchingCardCrossField(tp,c92353449.cfilter,tp,LOCATION_HAND+LOCATION_DECK,0,1,1,nil)
...
function c92353449.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=aux.SelectMatchingCardCrossField(tp,c92353449.thfilter,tp,LOCATION_DECK,0,1,1,nil)
