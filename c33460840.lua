...
function c33460840.filter(c,ec)
	return c:IsRace(RACE_DRAGON) and c:IsLevel(7,8) and c:IsAbleToEquip()
end
function c33460840.eqtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c33460840.filter,tp,LOCATION_HAND+LOCATION_GRAVE,0,1,nil,e:GetHandler()) end
