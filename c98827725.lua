...
function c98827725.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
			and Duel.IsPlayerCanSpecialSummonMonster(tp,98827725,0x10db,0x11,0,300,4,RACE_WARRIOR,ATTRIBUTE_DARK) end
	e:SetLabel(0)
...
function c98827725.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.IsPlayerCanSpecialSummonMonster(tp,98827725,0x10db,0x11,0,300,4,RACE_WARRIOR,ATTRIBUTE_DARK) then
