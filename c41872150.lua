...
function c41872150.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(41872150,0))
	...
	e2:SetDescription(aux.Stringid(41872150,1))
...
function c41872150.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	c:RegisterFlagEffect(41872150,RESET_EVENT+0x1fc0000+RESET_PHASE+PHASE_END,0,1)
