...
function c17032740.cfilter(c,fc)
	return c:IsFusionCode(89943723,43237273,17732278) and c:IsAbleToDeckOrExtraAsCost() and c:IsCanBeFusionMaterial(fc,SUMMON_TYPE_SPECIAL)
end
...
function c17032740.spcon(e,c)
	...
	local mg=Duel.GetMatchingGroup(c17032740.cfilter,tp,LOCATION_ONFIELD,0,nil,c)
