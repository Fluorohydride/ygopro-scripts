...
function c38273745.initial_effect(c)
	...
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_NO_TURN_RESET,EFFECT_FLAG2_XMDETACH)
	...
	e2:SetProperty(EFFECT_FLAG_NO_TURN_RESET,EFFECT_FLAG2_XMDETACH)
	...
	e3:SetProperty(EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_NO_TURN_RESET,EFFECT_FLAG2_XMDETACH)
