...
function c66399653.initial_effect(c)
	...
	local custom_code=aux.RegisterMergedDelayedEvent_ToSingelCard(c,66399653,EVENT_SUMMON_SUCCESS,g)
	aux.RegisterMergedDelayedEvent_ToSingelCard(c,66399653,EVENT_SPSUMMON_SUCCESS,g,custom_code)
