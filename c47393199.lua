...
function c47393199.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then
		if e:GetLabel()==1 then
			e:SetLabel(0)
			return Duel.CheckReleaseGroup(REASON_COST,tp,c47393199.costfilter,1,c,c,tp)
		else
	...
	if e:GetLabel()==1 then
		e:SetLabel(0)
		local sg=Duel.SelectReleaseGroup(REASON_COST,tp,c47393199.costfilter,1,1,c,c,tp)
