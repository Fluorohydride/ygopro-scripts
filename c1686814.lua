...
function c1686814.initial_effect(c)
	c:EnableReviveLimit()
	aux.AddGenericSpSummonProcedure(c,LOCATION_EXTRA,c1686814.sprfilter,c1686814.sprgoal,2,2,LOCATION_MZONE,0,nil,HINTMSG_TOGRAVE,Duel.SendtoGrave,REASON_COST)
	--spsummon condition
