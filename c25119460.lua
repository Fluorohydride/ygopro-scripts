...
function c25119460.matfilter(c,fc)
	return c:IsFusionCode(65622692,64500000) and c:IsAbleToRemoveAsCost() and c:IsCanBeFusionMaterial(fc,SUMMON_TYPE_SPECIAL)
end
...
function c25119460.spcon(e,c)
	...
	local g=Duel.GetMatchingGroup(c25119460.matfilter,tp,LOCATION_ONFIELD,0,nil,c)
