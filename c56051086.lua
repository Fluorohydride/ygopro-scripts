...
function c56051086.filter(c)
	return c:IsSetCard(0x48) and c:IsType(TYPE_MONSTER) and c:IsAbleToEquip()
end
function c56051086.eqtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c56051086.filter,tp,LOCATION_GRAVE,0,1,nil) end
