...
function c59071624.initial_effect(c)
	...
	local custom_code=aux.RegisterMergedDelayedEvent_ToSingleCard(c,59071624,EVENT_TO_GRAVE,g)
	aux.RegisterMergedDelayedEvent_ToSingleCard(c,59071624,EVENT_REMOVE,g,custom_code)
