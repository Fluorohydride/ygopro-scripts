...
function c35334193.disop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToChain(0) and not tc:IsDisabled() then
		...
		if not c:IsRelateToChain(0) or not c:IsFaceup() or tc:IsImmuneToEffect(e) then return end
