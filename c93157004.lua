...
function c93157004.eqfilter(c)
	return c:IsSetCard(0x30) and c:IsType(TYPE_MONSTER) and c:IsAbleToEquip()
end
function c93157004.eqtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chk==0 then return Duel.IsExistingTarget(c93157004.eqfilter,tp,LOCATION_GRAVE,0,1,nil) end
