...
function c61884774.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if op==0 then
		...
		local g=aux.SelectMatchingCardCrossField(tp,c61884774.thfilter,tp,LOCATION_DECK,0,1,1,nil)
		...
		tc1:RegisterFlagEffect(61884774,RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END+RESET_OPPO_TURN,0,1,fid)
		tc2:RegisterFlagEffect(61884774,RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END+RESET_OPPO_TURN,0,1,fid)
