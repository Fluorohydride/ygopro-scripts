...
function c14644902.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local rg=Duel.SelectReleaseGroup(REASON_COST,tp,c14644902.rfilter,1,1,aux.ExceptThisCard(e),e,tp)
	...
	if #rg==0 then
		rg=Duel.SelectReleaseGroup(REASON_COST,tp,c14644902.rfilter2,1,1,aux.ExceptThisCard(e),tp)
		if #rg>0 then
