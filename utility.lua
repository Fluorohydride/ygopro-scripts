...
function Auxiliary.AddSynchroProcedure(c,f1,f2,minc,maxc)
	...
	e1:SetCondition(Auxiliary.SynMixCondition(aux.Tuner(f1),nil,nil,f2,minc,maxc,nil))
	e1:SetTarget(Auxiliary.SynMixTarget(aux.Tuner(f1),nil,nil,f2,minc,maxc,nil))
	e1:SetOperation(Auxiliary.SynMixOperation(aux.Tuner(f1),nil,nil,f2,minc,maxc,nil))
