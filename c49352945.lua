...
function c49352945.cfilter(c,fc)
	return c:IsFusionCode(89943723,17955766,54959865) and c:IsAbleToDeckOrExtraAsCost() and c:IsCanBeFusionMaterial(fc,SUMMON_TYPE_SPECIAL)
end
...
function c49352945.spcon(e,c)
	...
	local mg=Duel.GetMatchingGroup(c49352945.cfilter,tp,LOCATION_ONFIELD,0,nil,c)
