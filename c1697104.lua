...
function c1697104.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetFieldGroupCount(tp,LOCATION_MZONE,0)==0 and ep~=tp and re:IsActiveType(TYPE_TRAP) and re:IsHasType(EFFECT_TYPE_ACTIVATE) 
...
function c1697104.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=aux.SelectMatchingCardCrossField(tp,aux.NecroValleyFilter(c1697104.spfilter),tp,LOCATION_HAND+LOCATION_DECK+LOCATION_GRAVE,0,1,1,nil,e,tp)
	...
	tc:RegisterFlagEffect(1697104,RESET_EVENT+0x1fe0000,0,1,fid)
	c:RegisterFlagEffect(1697104,RESET_EVENT+0x1fe0000,0,1,fid)
