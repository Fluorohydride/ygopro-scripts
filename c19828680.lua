...
function c19828680.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 and Duel.SendtoGrave(g,REASON_EFFECT+REASON_DISCARD)~=0
		...
		and Duel.IsExistingMatchingCard(aux.NecroValleyFilter(c19828680.spfilter,e),tp,LOCATION_GRAVE,0,1,nil,e,tp)
		and Duel.SelectYesNo(tp,aux.Stringid(19828680,0)) then
		Duel.BreakEffect()
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
		local sg=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c19828680.spfilter,e),tp,LOCATION_GRAVE,0,1,1,nil,e,tp)
