...
function c21744288.costfilter(c)
	return c:IsType(TYPE_SPELL)
end
function c21744288.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsReleasable()
		and Duel.CheckDiscardHand(tp,c21744288.costfilter,1,REASON_COST+REASON_DISCARD) end
	Duel.Release(e:GetHandler(),REASON_COST)
	Duel.DiscardHand(tp,c21744288.costfilter,1,1,REASON_COST+REASON_DISCARD)
end
