...
function c96561011.spcon(e,c)
	...
	return ft>-1 and Duel.CheckReleaseGroupEx(tp,c96561011.rfilter,1,REASON_SPSUMMON,false,nil,ft,tp)
end
function c96561011.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	local g=Duel.SelectReleaseGroupEx(tp,c96561011.rfilter,1,1,REASON_SPSUMMON,false,nil,ft,tp)
