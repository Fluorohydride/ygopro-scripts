...
function c12381100.discon(e,tp,eg,ep,ev,re,r,rp)
	return rp==1-tp and not e:GetHandler():IsStatus(STATUS_BATTLE_DESTROYED) and Duel.IsChainNegatable(ev)
		...
		or (re:IsActiveType(TYPE_SPELL) and Duel.GetFlagEffect(tp,12381100+1)==0)
		or (re:IsActiveType(TYPE_TRAP) and Duel.GetFlagEffect(tp,12381100+2)==0))
end
function c12381100.distg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	elseif re:IsActiveType(TYPE_SPELL) then
		Duel.RegisterFlagEffect(tp,12381100+1,RESET_PHASE+PHASE_END,EFFECT_FLAG_OATH,1)
		local e1=Effect.CreateEffect(c)
		...
		Duel.RegisterFlagEffect(tp,12381100+2,RESET_PHASE+PHASE_END,EFFECT_FLAG_OATH,1)
		local e1=Effect.CreateEffect(c)
