...
function c75043725.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g1=aux.SelectMatchingCardCrossField(tp,c75043725.filter,tp,LOCATION_DECK,0,1,1,nil)
	local tc1=g1:GetFirst()
	Duel.Hint(HINT_SELECTMSG,1-tp,HINTMSG_ATOHAND)
	local g2=aux.SelectMatchingCardCrossField(1-tp,c75043725.filter,tp,0,LOCATION_DECK,1,1,nil)
