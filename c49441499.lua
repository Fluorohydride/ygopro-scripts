...
function c49441499.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--reg
	aux.RegisterSummonFlag(c,EVENT_SUMMON_SUCCESS,49441499)
	aux.RegisterSummonFlag(c,EVENT_SPSUMMON_SUCCESS,49441499)
	aux.RegisterSummonFlag(c,EVENT_FLIP,49441499)
end
