...
function c91420254.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(91420254,0))
	...
	e2:SetDescription(aux.Stringid(91420254,1))
	e2:SetCategory(CATEGORY_POSITION)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e2:SetCode(EVENT_SUMMON_SUCCESS)
	e2:SetTarget(c91420254.postg)
	e2:SetOperation(c91420254.posop)
	c:RegisterEffect(e2)
