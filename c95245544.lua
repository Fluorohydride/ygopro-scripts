...
function c95245544.costfilter(c)
	return c:IsType(TYPE_SPELL)
end
function c95245544.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsReleasable()
		and Duel.CheckDiscardHand(tp,c95245544.costfilter,1,REASON_COST+REASON_DISCARD) end
	Duel.Release(e:GetHandler(),REASON_COST)
	Duel.DiscardHand(tp,c95245544.costfilter,1,1,REASON_COST+REASON_DISCARD)
end
