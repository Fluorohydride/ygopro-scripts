...
function c27784944.tfop(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=aux.SelectMatchingCardCrossField(tp,aux.NecroValleyFilter(c27784944.tffilter),tp,LOCATION_HAND+LOCATION_GRAVE+LOCATION_DECK,0,1,1,nil,tp):GetFirst()
	if tc then
