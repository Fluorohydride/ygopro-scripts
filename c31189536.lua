...
function c31189536.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=aux.SelectMatchingCardCrossField(tp,c31189536.filter,tp,LOCATION_DECK,0,1,1,nil,e,tp)
	local tc=g:GetFirst()
	if tc and Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP)~=0 then
		local fid=e:GetHandler():GetFieldID()
		tc:RegisterFlagEffect(31189536,RESET_EVENT+0x1fe0000,0,1,fid)
...
function c31189536.descon(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:GetFlagEffectLabel(31189536)~=e:GetLabel() then
		e:Reset()
		return false
