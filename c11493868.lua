...
function c11493868.initial_effect(c)
	...
	e2:SetOperation(c11493868.atkop1)
	c:RegisterEffect(e2)
	--spsummon
	...
	e3:SetCost(c11493868.spcost)
	e3:SetTarget(c11493868.sptg)
	e3:SetOperation(c11493868.spop)
	c:RegisterEffect(e3)
end
...
function c11493868.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	Duel.SelectTarget(tp,c11493868.atkfilter,tp,LOCATION_MZONE,0,1,1,nil)
end
function c11493868.atkop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetValue(800)
	e1:SetReset(RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_STANBY+RESET_SELF_TURN,2)
	tc:RegisterEffect(e1)
end
function c11493868.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c11493868.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
...
function c11493868.spop(e,tp,eg,ep,ev,re,r,rp)
	local chkf=Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and PLAYER_NONE or tp
	local mg1=Duel.GetMatchingGroup(c11493868.filter1,tp,LOCATION_MZONE,0,nil,e)
