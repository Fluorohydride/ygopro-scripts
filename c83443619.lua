...
function c83443619.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and Duel.Destroy(tc,REASON_EFFECT)~=0 then
		...
		local g=aux.SelectMatchingCardCrossField(tp,c83443619.spfilter,tp,LOCATION_DECK,0,1,1,nil,e,tp)
...
function c83443619.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=aux.SelectMatchingCardCrossField(tp,c83443619.thfilter,tp,LOCATION_DECK,0,1,1,nil)
	if g:GetCount()>0 then
