...
function c37961969.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(37961969,1))
	e3:SetCategory(CATEGORY_SPECIAL_SUMMON+CATEGORY_FUSION_SUMMON+CATEGORY_GRAVE_ACTION)
	e3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e3:SetCode(EVENT_TO_GRAVE)
	e3:SetCountLimit(1,37961969+100)
	e3:SetProperty(EFFECT_FLAG_DELAY)
	e3:SetCondition(c37961969.condition)
	e3:SetTarget(c37961969.target)
	e3:SetOperation(c37961969.activate)
	c:RegisterEffect(e3)
end
