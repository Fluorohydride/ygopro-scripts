...
function c9334391.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g1=aux.SelectMatchingCardCrossField(tp,c9334391.thfilter,tp,LOCATION_DECK,0,1,1,nil,tp)
	if g1:GetCount()>0 and Duel.SendtoHand(g1,nil,REASON_EFFECT)~=0
		...
		local g2=aux.SelectMatchingCardCrossField(tp,c9334391.plfilter,tp,LOCATION_DECK,0,1,1,nil,g1:GetFirst():GetCode())
