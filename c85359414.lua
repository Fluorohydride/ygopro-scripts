...
function c85359414.filter(c)
	return c:IsFaceup() and c:IsCode(59364406) and not c:IsHasEffect(EFFECT_OLD_UNION)
end
...
function c85359414.descon(e,tp,eg,ep,ev,re,r,rp)
	return aux.uncon(e) and ep~=tp and eg:GetFirst()==e:GetHandler():GetEquipTarget()
end
