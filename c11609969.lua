...
function c11609969.initial_effect(c)
	...
	e2:SetCountLimit(1)
	e2:SetCondition(c11609969.sccon)
	e2:SetTarget(c11609969.sctg)
	e2:SetOperation(c11609969.scop)
	c:RegisterEffect(e2)
	--tohand
	...
	e3:SetCountLimit(1,11609969)
	e3:SetTarget(c11609969.thtg)
	e3:SetOperation(c11609969.thop)
	c:RegisterEffect(e3)
	local e4=e3:Clone()
