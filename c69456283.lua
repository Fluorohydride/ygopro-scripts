...
function c69456283.initial_effect(c)
	...
	e6:SetValue(c69456283.unilimit)
	c:RegisterEffect(e6)
end
...
function c69456283.unilimit(e,c)
	return c:IsCode(48202661)
end
function c69456283.eqlimit(e,c)
	return c:IsCode(48202661) or e:GetHandler():GetEquipTarget()==c
end
...
function c69456283.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	aux.SetUnionState(c,c69456283.eqlimit)
end
