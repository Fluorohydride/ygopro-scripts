...
function s.initial_effect(c)
	...
	local custom_code=aux.RegisterMergedDelayedEvent_ToSingleCard(c,id,EVENT_TO_GRAVE,g)
	aux.RegisterMergedDelayedEvent_ToSingleCard(c,id,EVENT_REMOVE,g,custom_code)
