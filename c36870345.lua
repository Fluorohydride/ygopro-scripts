...
function c36870345.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(36870345,0))
	...
	e2:SetDescription(aux.Stringid(36870345,1))
...
function c36870345.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and e:GetHandler():IsAbleToEquip()
