...
function c83682209.initial_effect(c)
	...
	e3:SetOperation(c83682209.checkop)
	c:RegisterEffect(e3)
	e2:SetLabelObject(e3)
end
function c83682209.checkop(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetOperation(c83682209.resetop)
	e1:SetLabelObject(e)
	Duel.RegisterEffect(e1,tp)
	local e2=e1:Clone()
	e2:SetCode(EVENT_BREAK_EFFECT)
	e2:SetOperation(c83682209.resetop2)
	e2:SetReset(RESET_CHAIN)
	e2:SetLabelObject(e1)
	Duel.RegisterEffect(e2,tp)
end
function c83682209.resetop(e,tp,eg,ep,ev,re,r,rp)
	--this will run after EVENT_SPSUMMON_SUCCESS
	e:GetLabelObject():SetLabelObject(nil)
	e:Reset()
end
function c83682209.resetop2(e,tp,eg,ep,ev,re,r,rp)
	local e1=e:GetLabelObject()
	e1:GetLabelObject():SetLabelObject(nil)
	e1:Reset()
	e:Reset()
end
function c83682209.spfilter(c,tp,se)
...
function c83682209.spcon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c83682209.spfilter,1,nil,tp,e:GetLabelObject():GetLabelObject()) and not eg:IsContains(e:GetHandler())
end
