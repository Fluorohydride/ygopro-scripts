...
function c16024176.hspfilter(c)
	return c:IsSetCard(0xe6) and c:GetLevel()==1 and not c:IsCode(16024176)
end
function c16024176.hspcon(e,c)
	if c==nil then return true end
	return Duel.GetLocationCount(c:GetControler(),LOCATION_MZONE)>-1
		and Duel.CheckReleaseGroup(c:GetControler(),c16024176.hspfilter,1,nil)
end
function c16024176.hspop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.SelectReleaseGroup(c:GetControler(),c16024176.hspfilter,1,1,nil)
